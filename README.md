...
- Set up a React JS project with npm `create vite@latest` and follow the prompts and after installation instructions.
...
## REFERENCES
- Artify-Chainlink-Hackathon PROJECT
- https://github.com/pope-h/Ballot_dApp/blob/main/ballot-dapp/src/App.jsx